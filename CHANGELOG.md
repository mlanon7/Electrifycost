...
The sister-site session handed off its 2026-07-04 simulator overhaul (`HANDOFF_FROM_PROJECTCOSTPRO_2026-07-04.md`); this is the behavioral port into the Astro/React/TS idiom, plus the 30C expiry that came due the same day:
