...
npm run build             # must complete cleanly + emit 500 URLs in sitemap.xml
```
...
- [ ] `npm run build` completes and emits 500 URLs in `dist/sitemap.xml` (200 city pages are `noindex`)
